...
from ops import  get_data_moving_MNIST, make_tensorboard, ae_optimization
...
def run_train(args):
    ...
    loss, step, train_step, global_step = ae_optimization(args, x_in, im_out)
    summary_op = make_tensorboard(x_in,im_out, loss, args)
