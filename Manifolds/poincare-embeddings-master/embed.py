...
def main():
    ...
    parser.add_argument('-checkpoint', default='/hype_embeddings.pth',
                        help='Where to store the model checkpoint')
    parser.add_argument('-dset', type=str, required=True,default='/vol/medic01/users/av2514/Pycharm_projects/Poincare_embeddings/wordnet/mammal_closure.csv ',
    ...
    opt.checkpoint = os.path.join('/vol/medic01/users/av2514/Pycharm_projects/Poincare_embeddings/logs',opt.checkpoint)
